<template>
  <div class="content-box">
    <div class="header__title">所有的未上门客户</div>
...
export default {
  name: 'never-visit',
  data () {
    let store = this.$getStore('neverVisit')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('neverVisit', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/notVisit/queryList',
