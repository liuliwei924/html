<template>
  <div class="content-box">
    <div class="header__title">预约未上门信息</div>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="openForm(scope.row.applyId)">预约上门</el-button>
...
<script>
import ReservationVisit from '@/components/business/ReservationVisit'
export default {
  name: 'fill-cust',
  data () {
    let store = this.$getStore('fillCust')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('fillCust', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/fillInfo/queryList',
