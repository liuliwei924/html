<template>
  <div class="content-box">
    <div class="header__title">所有客户</div>
      ...
      <el-form :model="searchForm">
        ...
        <el-form-item label="状态:">
          <el-select v-model="searchForm.status" clearable placeholder="请选择">
            <el-option v-for="val,key,index in status" :label="val" :value="key" :key="index"></el-option>
          </el-select>
        </el-form-item>
...
export default {
  name: 'back-all-cust',
  data () {
    let store = this.$getStore('backAllCust')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('backAllCust', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/bankReviewAll/queryList',
