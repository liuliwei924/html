<template>
  <div class="content-box">
    <div class="header__title">退回客户</div>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" class="table__danger" size="small" @click="checkSysReview(scope.row.applyId)">重新提交</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  name: 'org-back',
  data () {
    let store = this.$getStore('orgBack')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('orgBack', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/goBack/queryList',
    ...
    checkSysReview (applyId) {
      this.$ajax({
        url: '/crmsys/account/busi/goBack/checkSysReview',
