<template>
  <div class="content-box">
    <div class="header__title">录单中</div>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="viewHandle(scope.row.applyId, 'edit')">编辑</el-button>
          <el-button type="text" class="table__danger" size="small" @click="checkSysReview(scope.row.applyId)">提交审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  name: 'info-filling',
  data () {
    let store = this.$getStore('infoFilling')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('infoFilling', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/enterInfo/queryList',
    ...
    checkSysReview (applyId) {
      this.$ajax({
        url: '/crmsys/account/busi/enterInfo/checkSysReview',
