<template>
  <div class="content-box">
    <div class="header__title">复核通过</div>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="viewHandle(scope.row.applyId)">查看</el-button>
...
export default {
  name: 'review-pass',
  data () {
    let store = this.$getStore('reviewPass')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('reviewPass', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/reviewSuccess/queryList',
