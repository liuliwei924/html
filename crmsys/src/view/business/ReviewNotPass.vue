<template>
  <div class="content-box">
    <div class="header__title">复核不通过</div>
...
<script>
export default {
  name: 'review-not-pass',
  data () {
    let store = this.$getStore('reviewNotPass')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('reviewNotPass', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/reviewFail/queryList',
