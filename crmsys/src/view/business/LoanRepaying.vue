<template>
  <div class="content-box">
    <div class="header__title">还款中</div>
...
export default {
  name: 'loan-Repaying',
  data () {
    let store = this.$getStore('loanRepaying')
    return {
      searchForm: {
  ...
  methods: {
    // 查询处理
    searchHandle (params) {
      if (params === 'store') this.$setStore('loanRepaying', this.searchForm)
      this.$ajax({
        url: '/crmsys/account/busi/repayment/queryList',
