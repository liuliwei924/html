      ...
      <el-form ref="form" :model="form">
        <div class="el-row is-required">
          ...
          <el-form-item class="el-col w16" prop="type">
            <el-select v-model="form.type" filterable clearable placeholder="产品类型">
       ...
       <el-form-item class="el-col w16" prop="orgName">
        ...
        <div class="el-row is-required">
          ...
          <el-form-item class="el-col w16" prop="indexNum">
...
<script>
import ProdTransfer from '@/components/loanProd/ProdTransfer'
