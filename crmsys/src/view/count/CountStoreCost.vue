<template>
  <div class="content-box">
    <div class="header__title">门店人员成本统计</div>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      exportForm: {
        dateType: 'day',
        exportType: 'storeCost',
        sumType: 'storeCostSum',
        exportParams: '',
      ...
      rows: [
        {
          ...
          rows: [
            ...
            {label: '业务员', prop: 'realName', minWidth: 120},
  ...
  methods: {
    ...
    searchMonth (page) {
      ...
      if (this.searchLoading) {
        this.$ajax({
          url: '/store/account/dataset/storeCost/query',
          data: obj,
          success: data => {
