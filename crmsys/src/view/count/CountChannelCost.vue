<template>
  <div class="content-box">
    <div class="header__title">渠道数据成本统计</div>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      exportForm: {
        dateType: 'day',
        exportType: 'channelCost',
        sumType: 'channelCostSum',
        exportParams: '',
      ...
      rows: [
        {
          ...
          rows: [
            ...
            {label: '渠道类型', prop: 'typeText', minWidth: 120}
          ]
        },
        {
          label: 'API数据',
  ...
  methods: {
    ...
    searchMonth (page) {
      ...
      if (this.searchLoading) {
        this.$ajax({
          url: '/store/account/dataset/channelCost/query',
          data: obj,
          success: data => {
