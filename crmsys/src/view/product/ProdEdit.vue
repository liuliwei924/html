      ...
      <el-form ref="form" :model="form">
        ...
        <div class="el-row is-required">
          ...
          <div class="el-col el-col-20">
            <el-form-item prop="minAge" class="w16" :rules="{type: 'number', required: true, message: '最小年龄不能为空', trigger: 'blur'}">
              <el-input v-model.number="form.minAge" placeholder="请输入最小年龄"></el-input>
            </el-form-item>
            <div class="item-line">—</div>
            <label class="el-form-item__label w110">
              <span>最大年龄:</span>
            </label>
            <el-form-item prop="maxAge" class="w16" :rules="{type: 'number', required: true, message: '最大年龄不能为空', trigger: 'blur'}">
              <el-input v-model.number="form.maxAge" placeholder="请输入最大年龄"></el-input>
            </el-form-item>
        ...
        <div class="el-row is-required">
          ...
          <div class="el-col el-col-20">
            <el-form-item prop="minLoan" class="w16" :rules="{type: 'number', required: true, message: '最小贷款金额不能为空', trigger: 'blur'}">
              <el-input v-model.number="form.minLoan" placeholder="请输入最小贷款金额"></el-input>
            </el-form-item>
            <div class="item-line">—</div>
            <label class="el-form-item__label w110">
              <span>最大贷款金额:</span>
            </label>
            <el-form-item prop="maxLoan" class="w16" :rules="{type: 'number', required: true, message: '最大贷款金额不能为空', trigger: 'blur'}">
              <el-input v-model.number="form.maxLoan" placeholder="请输入最大贷款金额"></el-input>
            </el-form-item>
        ...
        <div class="el-row is-required" v-if="form.repayDayType === 1">
          ...
          <div class="el-col el-col-20">
            <el-form-item class="w16" prop="repayDay" :rules="{min: 1, max: 30, required: true, message: '还款日不能为空', trigger: 'blur'}">
              <el-input v-model="form.repayDay" class="lg-input" placeholder="请输入还款日"></el-input>
            </el-form-item>
        ...
        <div class="el-row is-required">
          ...
          <div class="el-col el-col-20">
            <el-form-item class="w16" prop="advanceDay" :rules="{min: 1, max: 30, required: true, message: '垫资日不能为空', trigger: 'blur'}">
              <el-input v-model="form.advanceDay" class="lg-input" placeholder="请输入垫资日"></el-input>
            </el-form-item>
            <div class="el-input-group__append">日</div>
          </div>
        </div>
    ...
    getProduct () {
      this.$ajax({
        ...
        success: data => {
          ...
          this.form.formulaId = form['formulaId'] || ''
