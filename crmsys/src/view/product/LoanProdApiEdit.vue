    ...
    <div class="product-form">
     ...
     <!--    <div class="el-row is-required">
       ...
       <el-form-item class="el-col w16" prop="orgName">
        ...
        <div class="el-row is-required" v-if="form.type===1">
          <label class="el-col el-col-4 el-form-item__label">
            <span>金额选项:</span>
          </label>
        ...
        <div class="el-row is-required" v-show="form.type===1">
          <label class="el-col el-col-4 el-form-item__label">
            <span>其他信息配置:</span>
          </label>
        ...
        <div class="el-row is-required" v-if="form.type===2">
          <label class="el-col el-col-4 el-form-item__label">
            <span>申请总次数:</span>
          </label>
          <el-form-item class="el-col w16" prop="applyCount" >
            <el-input v-model.number="form.applyCount" placeholder="请输入申请总次数" @change="checkOutNum"></el-input>
          </el-form-item>
        </div>
       ...
       <div class="el-row is-required">
        ...
        <div class="el-row is-required">
          ...
          <el-form-item class="el-col w410" prop="showType">
            <el-select
              ...
              multiple
              placeholder="显示终端">
              <el-option v-for="val,key,index in showTypeData" :label="val.name" :value="val.val" :key="index"></el-option>
            </el-select>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
    ...
    // 数值替换
    checkOutNum (value) {
      this.form.applyCount = value.replace(/[^0-9-]+/, '')
    }
  },
  components: {
    ProdTransfer,
