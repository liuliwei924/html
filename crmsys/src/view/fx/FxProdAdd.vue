          ...
          <el-form ref="form" :model="form">
            ...
            <div class="el-row is-required">
              ...
              <el-form-item class="el-col fl w350" prop="compName">
                <el-input v-model="form.compName" placeholder="请输入公司名称"></el-input>
              </el-form-item>
            </div>
            <div class="el-row is-required">
              <label class="el-col el-col-4 el-form-item__label">
            ...
            <div class="el-row is-required">
              ...
              <el-form-item class="el-col w350" prop="strKey">
                <el-input v-model="form.strKey" type="textarea" class="t2-textarea" :maxlength="150" placeholder="银行返回结果匹配关键词以英文逗号分隔"></el-input>
              </el-form-item>
            </div>
            <div class="el-row is-required">
              <label class="el-col el-col-4 el-form-item__label">
    ...
    saveHandle () {
      ...
      this.$refs['form'].validate(valid => {
        if (valid) {
          ...
          this.$ajax({
            url: '/store/account/fx/fxProd/addProdInfo',
            data: this.form,
            success: data => {
              this.$router.back()
            }
