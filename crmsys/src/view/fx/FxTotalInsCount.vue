<template>
  <div class="content-box">
    <div class="header__title">保险申请统计</div>
    ...
    <el-table class="content__table" 
      ...
      <el-table-column
        prop="applyInsNums"
        sortable
        label="保险申请数" align="center">
      </el-table-column>
      <el-table-column
        prop="applyInsCustNums"
        sortable
        label="保险申请人数" align="center">
      </el-table-column>
      <el-table-column
        prop="insNums"
        sortable
        label="保险完成数" align="center">
      </el-table-column>
    </el-table>
    <el-pagination
        ...
        callback: action => {
          if (action === 'confirm') {
            ...
            let title = [
              ...
              {'name': 'applyInsNums', 'title': '保险申请数'},
              {'name': 'applyInsCustNums', 'title': '保险申请人数'},
              {'name': 'insNums', 'title': '保险完成数'}
            ]
