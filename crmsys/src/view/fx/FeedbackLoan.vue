<template>
  <div class="content-box">
    <div class="header__title">贷款反馈数据</div>
    <div class="header__search clearfix">
      <el-form :model="searchForm" ref="searchForm">
        ...
        <el-upload class="upload-demo" :action="loanImportPath" accept="xls" :data="excelForm" :show-file-list="false" :before-upload="beforeUp" :on-success="upSuccess">
          <el-button size="small" icon="upload" type="primary" class="excelBtn" :loading="loading" @click.stop="uploadBtn" :disabled="loading">贷款数据导入</el-button>
        </el-upload>
    ...
    @sort-change="sortEvent">
      ...
      <el-table-column prop="applyTel" label="手机号" align="center" min-width="85">
      </el-table-column>
      <el-table-column prop="prodName" label="申请产品" align="center" min-width="70">
      </el-table-column>
      <el-table-column prop="creditAmt" label="放款金额" align="center" min-width="70">
      </el-table-column>
      <el-table-column prop="creditDeadline" label="放款期限" align="center" min-width="70">
      </el-table-column>
      <el-table-column prop="creditRate" label="放款利率" align="center" min-width="70">
      </el-table-column>
      ...
      <el-table-column prop="settleDate" label="结算日期" align="center" min-width="85">
      </el-table-column>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      loanImportPath: this.$baseURL + 'store/account/fx/feedbackData/loanImport',
      excelForm: {
        signId: signId
      },
      loading: false,
