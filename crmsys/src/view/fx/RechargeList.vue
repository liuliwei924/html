    ...
    <div class="header__search clearfix">
      <el-form :model="searchForm" ref="searchForm">
        ...
        <el-form-item label="充值类型" prop="rechargeType">
          <el-select v-model="searchForm.rechargeType" clearable placeholder="请选择充值类型">
    ...
    <el-table class="content__table" :data="tableData" border>
      ...
      <el-table-column prop="rechargeType" label="充值类型" align="center">
        <template slot-scope="scope">
          <span v-if ="scope.row.rechargeType==='fx'">分销系统</span>
          <span v-if ="scope.row.rechargeType==='tj'">推荐贷款</span>
        </template>
      </el-table-column>
      <el-table-column
        prop="fee"
...
<script>
import RechargeAdd from '@/components/fx/RechargeAdd'
...
export default {
  ...
  methods: {
    ...
    searchHandle () {
      this.$ajax({
        url: '/store/account/fx/rechargeData/queryRechargeList',
