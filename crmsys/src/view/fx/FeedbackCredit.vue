<template>
  <div class="content-box">
    <div class="header__title">信用卡反馈数据</div>
    <div class="header__search clearfix">
      <el-form :model="searchForm" ref="searchForm">
        ...
        <el-upload class="upload-demo" :action="excelImportPath" accept="xls" :data="excelForm" :show-file-list="false" :before-upload="beforeUp" :on-success="upSuccess">
          <el-button size="small" icon="upload" type="primary" class="excelBtn" :loading="loading" @click.stop="uploadBtn" :disabled="loading">信用卡数据导入</el-button>
        </el-upload>
    ...
    @sort-change="sortEvent">
      ...
      <el-table-column prop="cardNo" label="身份证" align="center" min-width="95">
      </el-table-column>  
      <el-table-column prop="prodName" label="申请产品" align="center" min-width="70">
      </el-table-column>
      <el-table-column prop="auditDate" label="批卡日期" align="center" min-width="70">
      </el-table-column>
      <el-table-column prop="applyDate" label="申请日期" align="center" min-width="70">
      </el-table-column>
      ...
      <el-table-column prop="settleAmt" label="结算佣金" align="center" min-width="85"
      ...
      <el-table-column prop="importTime" label="导入时间" align="center" min-width="100">
       ...
       <el-table-column prop="backStatus" label="反馈状态" align="center" min-width="70">
...
export default {
  ...
  data () {
    ...
    return {
      ...
      excelImportPath: this.$baseURL + 'store/account/fx/feedbackData/feedbackImport',
