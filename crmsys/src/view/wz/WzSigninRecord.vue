<template>
  <div class="content-box">
    <div class="header__title">签到记录</div>
  ...
  methods: {
    ...
    searchHandle () {
      this.tableData = []
       // 缓存查询条件
      this.$ajax({
        url: '/store/account/wz/wzSigninRecord/querySigninRecord',
