<template>
  <div class="content-box">
    <div class="header__title">转小小金融订单</div>
    <!-- 条件搜索栏 -->
...
export default {
  ...
  data () {
    ...
    // 缓存查询条件
    let store = this.$getStore('transferXxjr')
    return {
      searchForm: {
  ...
  methods: {
    ...
    searchHandle () {
      this.tableData = []
      // 缓存查询条件
      this.$setStore('transferXxjr', this.searchForm, ['startDate', 'endDate'])
      this.$ajax({
        url: '/store/account/work/transferXxjr/queryTransXxjr',
