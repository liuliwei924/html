<template>
  <div class="content-box">
    <div class="header__title">处理完成</div>
    <!-- 条件搜索栏 -->
    <div class="header__search clearfix">
      <el-form :model="searchForm">
        <el-form-item label="完成时间-起:">
          <el-date-picker
...
export default {
  ...
  data () {
    ...
    // 缓存查询条件
    let store = this.$getStore('signed')
    return {
      searchForm: {
        orgId: store['orgId'] || '',
        ...
        startFinishDate: isAuth ? firstDay : '',
        endFinishDate: isAuth ? today : '',
  ...
  methods: {
    ...
    searchHandle () {
      // 缓存查询条件
      this.$setStore('signed', this.searchForm, ['startFinishDate', 'endFinishDate'])
      this.$ajax({
        url: '/store/account/work/signed/querySignedList',
