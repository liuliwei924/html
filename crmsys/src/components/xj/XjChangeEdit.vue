<template>
  <el-dialog class="edit-dialog" title="编辑兑换项目" v-model="visible">
  ...
  watch: {
    ...
    custData (obj) {
      ...
      this.form = {
        ...
        changePrice: obj['changePrice'] + '' || 0,
        changeUnit: obj['changeUnit'] || '',
        changeValue: obj['changeValue'] + '' || 0,
        changeDesc: obj['changeDesc'] || '',
        priceDesc: obj['priceDesc'] || '',
        orderIndex: obj['orderIndex'] + '' || '',
        countValue: obj['countValue'] + '' || 0,
        typeId: obj['typeId'] || 0,
        status: obj['status'] || 0
      }
    },
  ...
  methods: {
    ...
    confirm () {
      this.$refs['form'].validate(valid => {
        if (valid) {
          this.$ajax({
            url: '/store/account/xj/xjChangeCfg/editChangePro',
            data: this.form,
            success: data => {
