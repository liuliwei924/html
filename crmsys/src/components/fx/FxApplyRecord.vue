    ...
    <div class="header__search clearfix">
      <el-form :model="searchForm" ref="searchForm">
        ...
        <el-form-item label="申请产品" prop="prodName">
          ...
          <el-input v-model="searchForm.applyId" placeholder="请输入申请ID"></el-input>
        </el-form-item>
    ...
    <el-table class="content__table" :data="tableData" border>
     <el-table-column prop="workNo" label="工号" align="center" min-width="40">
      ...
      <el-table-column prop="refererAmt1" label="一级奖金" align="center" min-width="30">
       ...
       <el-table-column prop="referer" label="链接推荐ID" align="center" min-width="30">
      </el-table-column>
      <el-table-column prop="prodName" label="申请产品" align="center" min-width="60">
      </el-table-column>
      <el-table-column prop="applyTime" label="申请时间" align="center" min-width="65">
      </el-table-column>
       <el-table-column prop="settleDate" label="结算日期" align="center" min-width="60">
      </el-table-column>
      ...
      <el-table-column prop="autoReward" label="自动发放状态" align="center" min-width="40">
        <template slot-scope="scope">
