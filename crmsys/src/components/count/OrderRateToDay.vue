...
export default {
  ...
  data () {
    ...
    // 缓存查询条件
    let store = this.$getStore('orderRateToDay')
    return {
      status: 3,
      signId: '',
      // 导出
      exportSearchParams: {},
      exportForm: {
        exportType: 'storeOrderRateToDay',
        exportParams: ''
      },
      defileName: 'orderRateToDay',
      searchForm: {
        startRecordDate: '',
        endRecordDate: '',
  ...
  methods: {
    getSummaries (param) {
      let nines = ['totalCount', 'rateOneCount', 'rateTwoCount', 'rateThreeCount', 'rateFourCount', 'rateFiveCount']
      let sums = ['总计', '']
      let arr = []
    ...
    queryRateTodaySum () {
      ...
      // 缓存查询条件
      this.$ajax({
        url: '/store/account/dataset/orderRateCount/queryRateTodaySum',
    ...
    searchHandle () {
      ...
      // 缓存查询条件
      this.$setStore('orderRateToDay', this.searchForm, ['startRecordDate', 'endRecordDate'])
      this.$ajax({
        url: '/store/account/dataset/orderRateCount/queryRateToday',
        data: this.searchForm,
        loading: true,
        success: data => {
