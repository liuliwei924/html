    ...
    <div class="all-info-content">
      <el-form
        ...
        <el-form-item
          label="职业身份"
          prop="workType"
          :rules="{type: 'number', required: true, message: '职业身份不能为空', trigger: 'blur'}">
          <el-select
  ...
  watch: {
    baseInfo (obj) {
      this.form = {
        ...
        zimaScore: obj['zimaScore'],
        isLocal: obj['isLocal'],
        socialAmount: obj['socialAmount'],
        socialMonth: obj['socialMonth'],
        liabiAmount: obj['liabiAmount'],
        myLicense: obj['myLicense'],
        hasLicense: obj['hasLicense'],
        // 收入情况
        jobMonth: obj['jobMonth'],
        wagesType: obj['wagesType'],
        income: obj['income'],
        cashMonth: obj['cashMonth'],
        fundNum: obj['fundNum']
      }
    },
    form: {
